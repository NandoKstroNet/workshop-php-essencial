...
$drive = "mysql:host=127.0.0.1;dbname=blog";
$pdo = new \PDO($drive, 'root', '');
$entity = new Entity($pdo);
...
if(isset($_GET['url']) && $_GET['url'] == 'save') {
	...
	if($blog->insert($_POST)) {
		header('Location: /blog/index.php?url=posts');
	} else {
		print $data;
	}
...
if(isset($_GET['url']) && $_GET['url'] == 'posts') {
	...
	require __DIR__ . '/views/posts.phtml';
}
